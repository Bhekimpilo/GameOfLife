...
# There are six players at most who take turns to spin and move their characters
# They have freedom to choose in some instances but in some tiles the commands are authoritative.
# The object of the game is to acquire as much wealth as on possibly can and the money is added up at the end
# Insurance, stock and houses are optional to buy
# Wedding gifts are mandatory from every player if one lands on the marriage tile
# That said, the board is colour coded as a way of giving instructions to the character as it moves by


Here are the colour code meanings

# RED - Stop and spin again but DO NOT move. In the case of a marriage you can spin either red or black to determine the gift amount each player gives you. In the Day of reckoning tile (last tile), you are to choose a number and spin, if that number turns up you move to millionnaire acres and you liquidate your assets and continue to collect rents and bridge tolls

# AMBER - You pause to pick an option but you continue until you have taken all the steps you pun
